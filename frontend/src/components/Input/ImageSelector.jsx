    ...
    return (
        <div>
            <input
                ...
                className='hidden'
            />
            {!image ? (<button className='w-full h-[220px] flex flex-col items-center justify-center gap-4 bg-slate-50 rounded border border-clate-200/50' onClick={() => onChooseFile()}>
